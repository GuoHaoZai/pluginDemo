...
//@SupportedAnnotationTypes("guohao.anno.Utils")
//public class UtilsProcessor extends AbstractProcessor {
//
...
//        Set<? extends Element> elementsAnnotatedWith = roundEnv.getElementsAnnotatedWith(Utils.class);
