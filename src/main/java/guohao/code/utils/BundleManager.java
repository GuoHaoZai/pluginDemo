...
public final class BundleManager {
    ...
    public static String getProjectBundle(@PropertyKey(resourceBundle = PROJECT_BUNDLE_NAME) String name, String... args) {
        return String.format(PROJECT.getString(name), args);
    }

    public static String getGeneratorBundle(@PropertyKey(resourceBundle = GENERATOR_BUNDLE_NAME) String name, String... args) {
